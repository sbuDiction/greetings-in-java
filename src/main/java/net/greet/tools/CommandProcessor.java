...
public class CommandProcessor extends GreetingsManager {
    ...
    public void Processor() throws SQLException {
        ...
        while (scanner.hasNext()) {
            ...
            if (verifyCommand(console_input[0])) {
                ...
                if (console_input[0].equals(Commands.clear.toString()) && console_input.length == 2) clear(console_input[0]); // deletes a specific username in the database.
                if (console_input[0].equals(Commands.greeted.toString()) && console_input.length == 1) greeted(); // retrieves all the names in the database.
